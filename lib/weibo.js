...
var OAUTH_HOST = 'https://api.weibo.com/oauth2/authorize';
var ACCESSURL = 'https://api.weibo.com/oauth2/access_token';
var APIURL = 'https://api.weibo.com/2/';
...
Weibo.prototype.api = function(key, params, callback) {
    if (key in apis) {
        ...
        var method = apiData.method.toLowerCase();
